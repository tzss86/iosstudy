...
*解决办法*：修改info—>Privacy - Location Always Usage Description、Privacy - Location Always and When In Use Usage Description、Privacy - Location When In Use Usage Description 的描述，需要描述得具体才行。

改为：若不允许,你将无法使用地图导览定位功能、景区内的景点语音讲解将无法根据你的位置推送给你。